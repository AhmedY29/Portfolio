...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
            ...
            <div className="flex flex-col justify-center items-center text-[20vw] lg:text-[200px] font-anton text-center leading-none overflow-hidden absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
                <p className="name-text flex">
